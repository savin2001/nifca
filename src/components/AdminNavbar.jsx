...
const AdminNavbar = () => {
  ...
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-primary/20 dark:border-primary/30 px-10 py-3">
      <div className="flex items-center gap-4 text-background-dark dark:text-background-light">
      ...
      <div className="flex flex-1 justify-end gap-8">
        <div className="flex items-center gap-8 text-sm font-medium text-background-dark/80 dark:text-background-light/80">
          <Link
            to="/dashboard"
