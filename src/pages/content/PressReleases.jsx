...
import usePressReleasesActions from '../../hooks/usePressReleasesActions';
...
const PressReleases = () => {
  ...
  const { createPressRelease, updatePressRelease, deletePressRelease, loading: actionLoading } = usePressReleasesActions();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        result = await updatePressRelease(editingId, formData);
      } else {
        result = await createPressRelease(formData);
      }
      ...
      if (result.success) {
        ...
        setNotification({
          ...
          message: isEditMode
            ? 'Your press release has been updated successfully.'
            : 'Your press release has been submitted successfully.'
        });
  ...
  const confirmDelete = async () => {
    ...
    const result = await deletePressRelease(deletingId);
    ...
    if (result.success) {
      ...
      setNotification({
        ...
        message: 'The press release has been deleted successfully.'
      });
  ...
  return (
    <div className="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden">
        ...
        <main className="px-40 flex flex-1 justify-center py-10">
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div className="flex flex-wrap justify-between items-center gap-4 p-4">
              <h1 className="text-background-dark dark:text-background-light text-3xl font-bold">Press Releases</h1>
              <button
      ...
      {/* Create/Edit Press Release Modal */}
      {isModalOpen && (
        <div className="modal modal-open">
          <div className="modal-box max-w-2xl">
            <h3 className="font-bold text-lg mb-4">
              {isEditMode ? 'Edit Press Release' : 'Create New Press Release'}
            </h3>
          ...
          <div className="modal-box">
            <div className="text-center">
              ...
              <p className="text-sm opacity-70">
                Are you sure you want to delete this press release? This action
                cannot be undone.
              </p>
            </div>
