...
const News = () => {
  ...
  const { createNews, updateNews, deleteNews, loading: actionLoading } = useNewsActions();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        result = await updateNews(editingId, formData, uploadMode);
      } else {
        result = await createNews(formData, uploadMode);
      }

      if (result.success) {
        // Reset form and close modal
        setFormData({ title: '', content: '', picture: null, pictureUrl: '', post_to_twitter: false, post_to_linkedin: false });
        ...
        setNotification({
          ...
          message: isEditMode
            ...
            : 'Your news article has been submitted successfully.'
        });
  ...
  const confirmDelete = async () => {
    ...
    if (result.success) {
      ...
      setNotification({
        ...
        message: 'The news article has been deleted successfully.'
      });
        ...
        <main className="px-40 flex flex-1 justify-center py-10">
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div className="flex flex-wrap justify-between items-center gap-4 p-4">
              <h1 className="text-background-dark dark:text-background-light text-3xl font-bold">News</h1>
              <button
        ...
        <div className="modal modal-open">
          <div className="modal-box max-w-2xl">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-control mb-4">
                <label className="label">
                  <span className="label-text font-semibold">Share to Social Media</span>
                </label>
                <div className="flex flex-col gap-3">
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    <span className="label-text flex items-center gap-2">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-info" fill="currentColor" viewBox="0 0 24 24">
                ...
                <label className="label">
                  <span className="label-text-alt text-neutral/60">
                    Select platforms where you want to automatically post this news article
                  </span>
                </label>
              </div>
