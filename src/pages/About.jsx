  ...
  return (
    <div className="">
      ...
      <div className="h-screen flex flex-col justify-center items-center font-light mt-12">
        <div className="w-full flex flex-col justify-center items-center h-auto bg-base-100 sm:text-lg md:text-3xl ">
          <div className="max-w-5xl">
            <h2 className="text-center mb-4 uppercase text-primary">
              What is NIFC
            </h2>
            <p className="text-lg text-center mb-8">
              The Nairobi International Financial Centre (NIFC) is a
              transformative project designed by the Kenyan government to
              position Nairobi as a premier financial hub in Africa. It is a key
              initiative under the Economic Pillar of Kenya’s Vision 2030
              project. The NIFC aims to attract global investment by providing
              an efficient, conducive environment for financial services and
              innovation. With a focus on modern infrastructure, regulatory
              transparency, and strategic partnerships, the NIFC will foster
              economic growth and facilitate capital flow across the region
              through its business-friendly environment.
            </p>
          </div>
        </div>

        <div className="w-full flex flex-col md:flex-row items-center justify-center h-auto bg-base-200 p-6">
          <div className="sm:text-md md:text-xl w-full flex justify-center items-center m-14 max-w-5xl">
            ...
            <div className="w-full md:w-1/2 flex flex-col items-start md:pl-10 mt-6 md:mt-0">
              <h2 className="sm:text-xl md:text-3xl font-extralight pb-6">
                By enabling businesses to thrive within a conductive,
                predictable and well-regulated ecosystem, the NIFC serves as a
                gateway for investors seeking access to the vast opportunities
                in Kenya and the broader African market.
              </h2>
            </div>
          </div>
        </div>
      ...
      <div className="h-auto mt-8 flex flex-col justify-center items-center font-light">
        <div className="sm:text-md md:text-xl max-w-5xl">
          <div className="w-full flex justify-center items-center h-1/3 bg-base-100 sm:text-lg md:text-3xl ">
            <h2 className="text-center md:w-1/2 text-primary uppercase">
              Explore the NIFC Ecosystem
            </h2>
          </div>
